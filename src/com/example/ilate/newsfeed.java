...
public class newsfeed extends Activity implements GetArrayList{
	...
	protected void onCreate(Bundle savedInstanceStace)
	{
		...
		async_tasked at = new async_tasked(newsfeed.this,this);
		at.execute("aaaaa","abcde","timeline");
			...
			public void onItemClick(AdapterView<?> arg0, final View arg1, final int arg2,
				...
				goToProf.setOnClickListener(new OnClickListener(){
					...
					public void onClick(View v) {
						Intent intent = new Intent(newsfeed.this,MyProfile.class);
						Bundle b = new Bundle();
